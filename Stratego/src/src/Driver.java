...
public class Driver {
    ...
    public static boolean processMenuCommand(int command) throws IOException {
    ...
    public static void playGame() throws IOException {
        Unit[][][] armies = new Unit[2][2][40]; // Player, Captured, and Piece
        setupArmies(armies);

        Unit[][] board = new Unit[10][10]; // X and Y axis
